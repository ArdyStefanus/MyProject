...
<!--                    <li class="nav-item mx-auto">
    ...
    <div class="container" style="margin-top: 100px;">
        ...
        <p style="letter-spacing: 2px; font-size: 24px; text-align: left;">
            <strong>
                JOB APPLY PROFESSIONAL
            </strong>
        </p>
        ...
        <div class="classic-tabs">
            ...
            <ul class="nav tabs-red" id="myClassicTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link  waves-light active show" id="profile-tab-classic" data-toggle="tab" href="#profile-classic" role="tab" aria-controls="profile-classic" aria-selected="true">Personal Data</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link waves-light" id="follow-tab-classic" data-toggle="tab" href="#follow-classic" role="tab" aria-controls="follow-classic" aria-selected="false">Study / Job History</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link waves-light" id="contact-tab-classic" data-toggle="tab" href="#contact-classic" role="tab" aria-controls="contact-classic" aria-selected="false">Job Application</a>
                </li>
            </ul>
            ...
            <div class="tab-content border-right border-bottom border-left rounded-bottom" id="myClassicTabContent">
                    ...
                    <div class="tab-pane fade active show" id="profile-classic" role="tabpanel" aria-labelledby="profile-tab-classic">
                        ...
                        <form class="needs-validation container" method="POST" action="process/processFormPro.jsp">
            ...
            Name
                                        ...
                                        <div class="col-sm-4 md-form">
                                            <input type="text" class="form-control" id="validationTooltip011" placeholder="First Name" name="1st" required>

                                        </div>

                                        <div class="col-sm-4 md-form">
                                            <input type="text" class="form-control" id="validationTooltip011" placeholder="Last Name" name="2nd"  required>
            ...
            Birth Day
                                        ...
                                        <div class="md-form col-sm-4">
                                            <input placeholder="Choose your birth day..." type="text" class="datepicker" name="birth"  required>
                                        </div>
            ...
            Status
                                        ...
                                        <select class="mdb-select md-form col-sm-4" name="sM" required>
                                            <option value="-" disabled="-">-</option>
            ...
            Citizen
                                        ...
                                        <select class="mdb-select md-form col-sm-4" name="citizen"  >
                                            <option value="-" disabled="-">-</option>
            ...
            Work in
                                        ...
                                        <div class="form-check form-check-inline col-sm-2">
                                            <input type="radio" class="form-check-input" id="rad_Indoor" name="rW" value="Indoor">
                                            <label class="form-check-label" for="rad_Indoor">Indoor</label>
                                        </div>

                                        <div class="form-check form-check-inline col-sm-2">
                                            <input type="radio" class="form-check-input" id="rad_Outdoor" name="rW" value="Outdoor">
                                            <label class="form-check-label" for="rad_Outdoor">Outdoor</label>
                                        </div>

                                        <div class="form-check form-check-inline col-sm-2">
                                            <input type="radio" class="form-check-input" id="rad_Combination" name="rW" value="Combination">
                                            <label class="form-check-label" for="rad_Combination">Combination</label>
                                        </div>
            ...
            Traveling on Branch
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <label class="col-sm-4 md-form">
                                            <strong>
            Mutation to All Branch
        </strong>
                                        </label>

                                        <div class="form-check form-check-inline" style="margin-left: 9px;">
                                            <input type="checkbox" class="form-check-input" id="mutation" name="mutation" value="Yes">
                                            <label class="form-check-label" for="mutation">Yes</label>
                                        </div>
            ...
            Driver License
                                        ...
                                        <div class="col-sm-6 md-form">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input" id="materialInline11" name="dLA" value="A">
                                                <label class="form-check-label" for="materialInline11">A</label>
                                            </div>

                                            <!-- Material inline 2 -->
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input" id="materialInline22" name="dLB" value="B/B1">
                                                <label class="form-check-label" for="materialInline22">B/B1</label>
                                            </div>

                                            <!-- Material inline 3 -->
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input" id="materialInline33" name="dLC" value="C">
                                                <label class="form-check-label" for="materialInline33">C</label>
                                            </div>
            ...
            Vehicle
                                        ...
                                        <div class="green-border-focus col-sm-6">
                                            <textarea class="md-form" id="exampleFormControlTextarea5" rows="3" placeholder="vehicle" name="ve"  ></textarea>
                                        </div>
            ...
            Criminal History
                                        ...
                                        <div class="form-check form-check-inline col-sm-2 ">
                                            <input type="radio" class="form-check-input" id="rad_cri_yes" name="rC" value="Yes">
                                            <label class="form-check-label" for="rad_cri_yes">Yes</label>
                                        </div>

                                        <div class="form-check form-check-inline col-sm-2">
                                            <input type="radio" class="form-check-input" id="rad_cri_no" name="rC" value="No">
                                            <label class="form-check-label" for="rad_cri_no">No</label>
                                        </div>

                                        <div class="col-sm-3 md-form">

                                            <input type="text" id="txt_criminalhist" placeholder="Description" name="cD" style="width: 100%;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <label class="col-sm-4 md-form">
                                            <strong>
            Family On Expedition / Shipping / etc.
        </strong>
                                        </label>

                                        <div class="form-check form-check-inline col-sm-2 ">
                                            <input type="radio" class="form-check-input" id="rad_familyExpe_yes" name="rFE" value="Yes"  >
                                            <label class="form-check-label" for="rad_familyExpe_yes">Yes</label>
                                        </div>

                                        <div class="form-check form-check-inline col-sm-2">
                                            <input type="radio" class="form-check-input" id="rad_familyExpe_no" name="rFE" value="No"  >
                                            <label class="form-check-label" for="rad_familyExpe_no">No</label>
                                        </div>

                                        <div class="col-sm-3 md-form">

                                            <input type="text" id="txt_familyExpe" placeholder="Description" name="fED" style="width: 100%;" required >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <label class="col-sm-4 md-form">
                                            <strong>
            Family On PT. SPIL or Subsidiary Company
        </strong>
                                        </label>

                                        <div class="form-check form-check-inline col-sm-2 ">
                                            <input type="radio" class="form-check-input" id="rad_familyOnSPIL_yes" name="rFPT" value="Yes"  >
                                            <label class="form-check-label" for="rad_familyOnSPIL_yes">Yes</label>
                                        </div>

                                        <div class="form-check form-check-inline col-sm-2">
                                            <input type="radio" class="form-check-input" id="rad_familyOnSPIL_no" name="rFPT" value="No"  >
                                            <label class="form-check-label" for="rad_familyOnSPIL_no">No</label>
                                        </div>

                                        <div class="col-sm-3 md-form">

                                            <input type="text" id="txt_familyExpe" placeholder="Description" name="fPD" style="width: 100%;" required >
            ...
            Glasses
                                        ...
                                        <div class="form-check form-check-inline col-sm-2 ">
                                            <input type="radio" class="form-check-input" id="rad_glasses_yes" name="rG" value="Yes">
                                            <label class="form-check-label" for="rad_glasses_yes">Yes</label>
                                        </div>

                                        <div class="form-check form-check-inline col-sm-2">
                                            <input type="radio" class="form-check-input" id="rad_glasses_no" name="rG" value="No">
                                            <label class="form-check-label" for="rad_glasses_no">No</label>
                                        </div>
            ...
            Do You Have Tattoo?
                                        ...
                                        <div class="form-check form-check-inline col-sm-2 ">
                                            <input type="radio" class="form-check-input" id="rad_tattoo_yes" name="rT" value="Yes"  >
                                            <label class="form-check-label" for="rad_tattoo_yes">Yes</label>
                                        </div>

                                        <div class="form-check form-check-inline col-sm-2">
                                            <input type="radio" class="form-check-input" id="rad_tattoo_no" name="rT" value="No"  >
                                            <label class="form-check-label" for="rad_tattoo_no">No</label>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <label class="col-sm-8" style="text-align: justify">
                                            <strong>
            Are you aware of any circumstances regarding your health or capacity to work that would interfere with your ability to perform the duties of the position?
                                        ...
                                        <div class="form-check form-check-inline" style="margin-left: 30px; margin-bottom: 20px;">
                                            <input type="checkbox" class="form-check-input" id="question1" name="q1" value="Yes">
                                            <label class="form-check-label" for="question1">Yes</label>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <label class="col-sm-8" style="text-align: justify">
                                            <strong>
            Do you suffer from or carry any infectious disease or illness?
        </strong>
                                        </label>

                                        <div class="form-check form-check-inline" style="margin-left: 30px; margin-bottom: 20px;">
                                            <input type="checkbox" class="form-check-input" id="question2" name="q2" value="Yes">
                                            <label class="form-check-label" for="question2">Yes</label>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <label class="col-sm-8" style="text-align: justify">
                                            <strong>
            Do you have an existing injury or condition or pre-existing injury or condition that could be affected by the nature of the proposed employment?
        </strong>
                                        </label>

                                        <div class="form-check form-check-inline" style="margin-left: 30px; margin-bottom: 20px;">
                                            <input type="checkbox" class="form-check-input" id="question3" name="q3" value="Yes">
                                ...
                                <!-- unused -->
                                <input type="hidden" class="form-control" name="etnis" placeholder="Tribe">
                                <input type="hidden" class="form-control" name="sS" placeholder="Size">
                                <input type="hidden" class="form-control" name="wPS" placeholder="Size">
                                <input type="hidden" class="form-control" name="shirtS" placeholder="Size">
                                <input type="hidden" class="form-control" name="bT" placeholder="Size">
                                <input type="hidden" class="form-control" name="pN" placeholder="Size">
                                <input type="hidden" class="form-control" name="pE" placeholder="Size">
                                <input type="hidden" class="form-control" name="sN" placeholder="Size">
                                <input type="hidden" class="form-control" name="sE" placeholder="Size">
                                <input type="hidden" class="form-control" name="mN" placeholder="Size">
                                <input type="hidden" class="form-control" name="cCS" placeholder="Size">
                                <input type="hidden" class="form-control" name="cN" placeholder="Size">
                                <input type="hidden" class="form-control" name="cI" placeholder="Size">
                                <input type="hidden" class="form-control" name="eN" placeholder="Size">
                                <input type="hidden" class="form-control" name="eI" placeholder="Size">
                                <input type="hidden" class="form-control" name="eL" placeholder="Size">
                                <input type="hidden" class="form-control" name="oL" placeholder="Size">
    ...
    <script>
        function submitForm()
        {
            window.location.href = '#studyHistory';
        }
    </script>
